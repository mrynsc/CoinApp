...
import com.pow.mining.adapter.ReferralAdapter;
import com.pow.mining.databinding.ActivityInviteBinding;
import com.pow.mining.model.Config;
import com.pow.mining.model.Referral;
import com.pow.mining.util.NetworkChangeListener;
import com.pow.mining.viewmodel.ReferralViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.copyBtn.setOnClickListener(view -> {
            String shareText = "Come to POW Network App and Earn POW Coin. Use my referral link. " +
                    "https://play.google.com/store/apps/details?id=" + getPackageName() + "&referrer=" + firebaseUser.getUid();
